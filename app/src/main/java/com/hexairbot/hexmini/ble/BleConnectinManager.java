...
public class BleConnectinManager  {
    ...
    private BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {  //젯쌈냥묘
            	Log.e(TAG, "Only gatt, just wait");
            } 
            else if (BluetoothLeService.ACTION_GATT_DISCONNECTED.equals(action)) { //뙤역젯쌈
            ...
            else if(BluetoothLeService.ACTION_GATT_SERVICES_DISCOVERED.equals(action)) //옵鹿역迦맴삶죄
            {
            	//Toast.makeText(BleConnectinManager.this.context, "젯쌈냥묘，君瞳옵鹿攣끽繫斤！", Toast.LENGTH_SHORT).show();
            	isConnected = true;
            ...
            else if (BluetoothLeService.ACTION_DATA_AVAILABLE.equals(action)) { //澗돕鑒앴
            	Log.e(TAG, "RECV DATA");
	...
	private  IntentFilter makeGattUpdateIntentFilter() {                        //鬧꿍쌈澗돨慤숭
